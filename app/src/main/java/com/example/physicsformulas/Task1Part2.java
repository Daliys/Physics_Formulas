...
public class Task1Part2 extends Fragment {
    ...
    public void SetContent(View view) {
        ...
        b1.setText(MainActivity.formulaLogic.logicTask1.questionFormulas.get(0).name);
        Button b2 = view.findViewById(R.id.button_answer2_part2);
        b2.setText(MainActivity.formulaLogic.logicTask1.questionFormulas.get(1).name);
        Button b3 = view.findViewById(R.id.button_answer3_part2);
        b3.setText(MainActivity.formulaLogic.logicTask1.questionFormulas.get(2).name);
        Button b4 = view.findViewById(R.id.button_answer4_part2);
        b4.setText(MainActivity.formulaLogic.logicTask1.questionFormulas.get(3).name);
        ImageView imageView = view.findViewById(R.id.imageView_question_part2);
        imageView.setImageResource(getResources().getIdentifier("formula_" + MainActivity.formulaLogic.logicTask1.rightAnswerFormula.id, "drawable", MainActivity.PACKAGE_NAME));
